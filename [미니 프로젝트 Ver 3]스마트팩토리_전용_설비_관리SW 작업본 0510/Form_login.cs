...
namespace _미니_프로젝트_Ver_3_스마트팩토리_전용_설비_관리SW
{
    public partial class Form_login : Form
    {
        ...
        // 전역 변수
        String connStr = "Server=192.168.56.101;Uid=smartUser;Pwd=1234;Database=factorydb;Charset=UTF-8"; // 연결 문자열
        ...
        {
            String str = "SELECT f1_time, f1_temper, f1_humi FROM factory1Tbl ORDER BY f1_time DESC LIMIT 1;";
            cmd.CommandText = str;
        ...
        private void myport_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            Humi = in_data.Substring(7, 2); // 습도값 읽은 string데이터를 잘라서 구분합시다.
            ...
            if (check == 0)
            {
                ...
                str = "INSERT INTO factory1Tbl(f1_time, f1_temper, f1_humi) ";
                ...
                if (TempInt > 28 || HumiInt > 30)
                {
                    Console.WriteLine("6\n");
                    str = "INSERT INTO warningTbl(w_time, factory, temper, humi) ";
